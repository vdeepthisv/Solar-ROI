...
<tr>
	<td> Email ID:</td><td><input name="emailid" id="emailid" type="text"></td>
</tr>
...
if (isset($_POST['submit'])) 
{
	...
	$password1 = $_POST['password1'];
	 $query = "SELECT * FROM Userdetails WHERE emailid = '".$emailid."' AND password1 = '".$password1."';" ;
	$result=mysql_query($query);
	$count=mysql_num_rows($result);

	if ($count> 0) {
			echo "Successful Login";
echo "<form name=\"activate\" action=\"Home.php\" method=\"get\">";
echo "<input type=\"submit\" value=\"Click to continue to home page\">";
echo "</form>";
			} else
	 {
	echo "Login failed.If you are a new user, please sign up from the signup tab above.";
	}
